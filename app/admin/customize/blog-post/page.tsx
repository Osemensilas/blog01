    ...
    return ( 
        ...
        <section className="h-max w-screen p-20">
            <div className="h-max w-full">
                ...
                <div className="h-max w-full flex gap-3 items-center mt-5">
                    <button type="button" className="p-1 bg-heading text-background">Edit Image</button>
                    <button type="button" className="p-1 bg-heading text-background">Edit Title</button>
                    <button type="button" className="p-1 bg-heading text-background">Edit Content</button>
                </div>
                ...
                <div className="h-max w-full mt-10">
                    ...
                    <div className="commentContainer">
                        ...
                        <div className="h-max w-full flex gap-3 items-center mt-5">
                            <button type="button" className="p-1 bg-heading text-background">Approve Post</button>
                            <button type="button" className="p-1 bg-heading text-background">Delete Post</button>
                        </div>
